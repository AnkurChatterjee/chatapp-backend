...
const mockTestCases = require("./searchGroupByName.test.constants");
const app = require("../../../../app");

describe("Testing search group by name without sending jwt token", () => {
...
describe("Testing search group by name by normal user", () => {
  let accessToken;
